...
@export_file("*.tscn") var game_menu_two : String
@export_file("*.tscn") var game_menu_tree : String
@export_file("*.tscn") var game_menu_four : String
